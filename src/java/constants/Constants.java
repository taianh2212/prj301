...
public class Constants {
    ...
    public static final String GOOGLE_CLIENT_ID = "533260573687-meeovv9390n1ivql1cvco0f5up944gee1.apps.googleusercontent.com";
    public static final String GOOGLE_CLIENT_SECRET = "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";
    public static final String GOOGLE_REDIRECT_URI = "http://localhost:9999/prj301/google-callback";
